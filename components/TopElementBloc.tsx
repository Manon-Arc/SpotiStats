    ...
    <Pressable
      ...
      <LinearGradient
        ...
        <View style={styles.contentContainer}>
          <View style={[styles.imageContainer, type === "artists" && styles.artistImageContainer]}>
            {type === "artists" ? (
              // Nouvelle disposition des artistes sur 3 lignes
              <View style={styles.artistsGrid}>
                {/* Première ligne: image centrale */}
                <View style={styles.artistsRow1}>
                  <Image source={{ uri: getImageUrl(0) }} style={styles.artistLargeImage} />
                </View>
              ...
              <View style={styles.tracksGrid}>
                <View style={styles.tracksRow}>
                  ...
                  <Image source={{ uri: getImageUrl(0) }} style={styles.trackLargeImage} />
