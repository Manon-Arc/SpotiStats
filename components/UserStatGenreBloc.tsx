...
export default function UserStatGenreBloc({ 
    genres = [], 
    maxGenres = 5 
}: UserStatGenreBlocProps) {
    ...
    const maxPercentage = topGenres.length > 0 ? topGenres[0].percentage : 100;
            ...
            <View style={styles.genresContainer}>
                {topGenres.length === 0 ? (
                    ...
                    topGenres.map((genre, index) => {
                        ...
                        const barWidth = `${(genre.percentage / maxPercentage) * 100}%`;
                                ...
                                <View style={styles.progressBarContainer}>
                                    <View 
                                        style={[
                                            ...
                                            index === 1 ? styles.progressBarSecond : 
